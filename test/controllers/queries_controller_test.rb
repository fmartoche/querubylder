...
class QueriesControllerTest < ActionController::TestCase
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post :create, query: { conditions: @query.conditions, dimensions: @query.dimensions, metrics: @query.metrics }
    end
  ...
  test "should update query" do
    patch :update, id: @query, query: { conditions: @query.conditions, dimensions: @query.dimensions, metrics: @query.metrics }
    assert_redirected_to query_path(assigns(:query))
  end
